...
and put all test possible to ensure that this can catch security issues with high accuracy. essentially you must create a benchmark that once i put my api key in, i can test the entire repo and it will provide me with what worked and what didn't.

use multiple agents and check what you create for errors and if works as intended
