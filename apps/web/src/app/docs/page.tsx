    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {DOC_SECTIONS.map((section) => (
          <div
            key={section.title}
            className="rounded-lg border border-gatepass-200 bg-white p-6"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gatepass-900">
                  {section.title}
                </h2>
              ...
              {section.articles.map((article) => (
                <li key={article}>
                  ...
                  >
                    ...
                    <ExternalLink
                      size={12}
                      className="ml-auto shrink-0 text-gatepass-300"
                    />
                  </a>
                </li>
              ))}
      ...
      <div className="rounded-lg border border-gatepass-200 bg-white p-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gatepass-500">
              Check the support page for live chat and ticket options, or browse
              our API reference for programmatic access.
            </p>
